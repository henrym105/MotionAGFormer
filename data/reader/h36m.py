# Copied from (https://github.com/calvinyeungck/AthletePose3D/blob/main/pose_3d/datareader_ap3d.py)
...
class DataReaderH36M(object):
    def __init__(self, n_frames, sample_stride, data_stride_train, data_stride_test, read_confidence=True,
                 dt_root='data/motion3d', dt_file=""):
        # NOTE: keeping dt_file param for compatibility, but not used in this implementation
        ...
        #read the data
        dt_train = read_pkl(f'{dt_root}/{train_file}')
        dt_valid = read_pkl(f'{dt_root}/{valid_file}')
